...
- The edit-point inventory substance (LICENSE, app Makefile SPDX/PKG_LICENSE/comment, trusttunnel-client SPDX inconsistency, README intro/acknowledgements), the owner go/no-go gate, the pre-flip clean-tree gate, and the single-commit requirement verified accurate. All five acceptance criteria have task coverage; AC3 is undermined by finding 2.
