...
- Guard chain, sysfs checks, attach/log-on-success semantics, exit-follows-attach, the path-override harness technique, and the TT-05 call contract all verified accurate. The hotplug file did not change on main.
