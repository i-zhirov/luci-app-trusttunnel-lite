...
- The full gate list, versions, ordering, the present-only conditional mechanism for the three planned test files, negative controls, and clean-room constraints verified accurate against ci.yml. ci.yml itself did not change on main.
