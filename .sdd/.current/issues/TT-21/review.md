...
- The skeleton/snapshot/diff machinery, uninstall/update/caveats facts, and single-file scope discipline verified sound. The decisive defect: the rebase actualization exists only in the framing sections.
