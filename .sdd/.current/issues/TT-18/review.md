...
- The actualized issue contract matches install.sh lines 186/188 and 249-257 exactly; release.yml/ci.yml citations, the uninstall.sh consistency contract, harness naming, and the clean-room rule verified. AC2/AC3/AC5 covered; AC1 and AC4 broken by the findings.
