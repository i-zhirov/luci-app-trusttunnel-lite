...
### [x] Task 1: Scenario harness + equivalence baseline

**Files:**

- Create: `tests/test_uci_defaults.sh`

- [x] **Step 1: Write the failing test — the harness itself**
...
- [x] **Step 3: Validate the harness against the known-good inherited behavior**
...
- [x] **Step 4: Record the static baseline**
...
- [x] **Step 2: Implement the dedup pass (contractual)**
...
### [x] Task 3: Zone + forwarding creation
...
- [x] **Step 2: Implement the creation phase (contractual)**
...
- [x] **Step 4: Regression check on the previous chunk**
...
- [x] **Step 2: Implement the migration phase (contractual)**
...
- [x] **Step 4: Regression check on the previous chunks**
...
### [x] Task 5: Routing profile seed block
...
- [x] **Step 2: Implement the profile-seed phase (contractual)**
...
### [x] Task 6: Cache clear, service enable, LuCI cache clear, exit 0
...
- [x] **Step 2: Implement the finalize phase (contractual)**
...
- [x] **Step 4: Regression check on all previous chunks**
...
### [x] Task 7: Idempotence, full suite, final gates
...
- [x] **Step 1: Verify idempotence explicitly**
...
- [x] **Step 3: Run the static gates on the new file**
...
- [x] **Step 4: Clean-room completeness check (PRD requirement)**
